...
import {
  ...
  updateHouseRules, updateReservationPreferences
...
const listingReducer = handleActions(
  {
    ...
    [combineActions(getListingAvailabilitySettings, updateReservationPreferences)]: produce((draft, action) => {
