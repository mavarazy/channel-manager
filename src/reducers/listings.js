...
import {
  ...
  updateNightlyPrice,
  updateDiscounts,
  updateExtraCharges, updateCurrency, updateGuestResources, updateDescription
...
const listingReducer = handleActions(
  {
    ...
    [combineActions(getListingDetails, updateGuestResources, updateDescription)]: produce((draft, action) => {
